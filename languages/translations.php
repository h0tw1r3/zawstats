<?php
   ...
   $g_aTranslation[] = array(
    ...
    "name" => "Magyar",
    "translations" => array(
      "[DAYS] days ago" => "[DAYS] nappal ezelőtt",
      "[HOURS]h [MINUTES]m ago" => "[HOURS] órával és [MINUTES] perccel ezelőtt",
      "[MINUTES] mins ago" => "[MINUTES] perccel ezelőtt",
      "1 day ago" => "1 napja",
      "1 min ago" => "1 perce",
      "10th" => "10.",
      "11th" => "11.",
      ...
      "April" => "Április",
      "At least one file required by MAWStats has been deleted, renamed or corrupted." => "Legalább egy szükséges fájl át lett nevezve, törölve lett vagy károsodott.",
      "August" => "Augusztus",
      "Browsers" => "Böngésző",
      "Cancel" => "Mégsem",
      "Cannot find required file [FILENAME]" => "A következő fájl nem található: [FILENAME]",
      "Change Language" => "Nyelv kiválasztása",
      "Change Month" => "Hónap kiválasztása",
      "Change Site" => "Weboldal kiválasztása",
      "Countries" => "Ország",
      "December" => "December",
      "February" => "Február",
      "Filetypes" => "Fájltípus",
      ...
      "Hours" => "Óránként",
      "January" => "Január",
      "MAWStats cannot find it's configuration file, [CONFIG]. Did you successfully copy and rename the [CONFIGDIST] file?" => "A következő konfigurációs fájl nem található: [CONFIG]. Az alapértelmezett [CONFIGDIST] konfigurációs fájl át lett nevezve és meg lett változtatva?",
      "MAWStats could not open an AWStats log file" => "Nem nyitható meg egyetlen AWStats logfájl sem",
      "July" => "Július",
      "June" => "Június",
      ...
      "Last updated [DAYNAME], [DATE] [MONTH] [YEAR] at [TIME] [ELAPSEDTIME] " => "Utolsó frissítés: [YEAR] [MONTH] [DATE], [DAYNAME] [TIME] [ELAPSEDTIME] ",
      "A total of [TOTALVISITS] visits ([UNIQUEVISITORS] unique) this month, an average of [DAILYAVERAGE] per day ([DAILYUNIQUE] unique)." => "Összesen [TOTALVISITS] látogatás ([UNIQUEVISITORS] egyedi) ebben a hónapban, átlagosan [DAILYAVERAGE] naponta ([DAILYUNIQUE] egyedi).",
      "March" => "Március",
      "May" => "Május",
      "Monday" => "Hétfő",
      "No AWStats Log Files Found" => "Nem található AWStats logfájl",
      "No individual AWStats configurations have been defined." => "Nincsenek egyedi AWStats konfigurációk definiálva.",
      "November" => "November",
      "October" => "Október",
      ...
      "Pages" => "Oldalak",
      "Please enter the password to update this site" => "Kérem adja meg a jelszót a statisztika frissítéséhez",
      "Please refer to the [LINKSTART]installation instructions[LINKEND] for more information." => "Kérjük olvassa el a [LINKSTART]telepítési útmutatót[LINKEND] további információkért!",
      "Please select the month you wish to view" => "Kérjük válasszon hónapot!",
      "Please select the site you wish to view" => "Kérjük válasszon weboldalt!",
      "Please select your language" => "Kérjük válasszon nyelvet!",
      "Powered by [AWSTART]AWStats[END]. Made beautiful by [MAWSTART]MAWStats Web Statistics and Analytics[END]." => "",
      ...
      "Sessions" => "Időtartam",
      "Spiders" => "Robotok",
      "Statistics for [SITE] in [MONTH] [YEAR]" => "[SITE] statisztika, [YEAR] [MONTH]",
      "Status" => "Státusz",
      "Sunday" => "Vasárnap",
      "The variable [VARIABLE] is missing or invalid." => "Hiányzó vagy érvénytelen változó: [VARIABLE]",
      "There is an error in [FILENAME]" => "Hiba a következő fájlban: [FILENAME]",
      "This Month" => "Aktuális hónap",
      "Thursday" => "Csütörtök",
      "Tuesday" => "Kedd",
      "Unknown" => "Ismeretlen",
      "Update" => "Frissítés",
      "Update Site" => "Statisztika frissítése",
      "Visitors" => "Látogató",
      "Wednesday" => "Szerda",
    )
  );
...
Un total de [TOTALVISITORS] visiteurs (dont [UNIQUEVISITORS] unique) ce mois, une moyenne de [DAILYAVERAGE] par jour (soit[DAILYUNIQUE] visiteurs uniques).",
  ...
  $g_aTranslation[] = array(
    ...
    "translations" => array(
      ...
      "Keyphrases" => "Suchaudrücke",
      "Keywords" => "Stichwörter",
      "עידכון אחרון [DAYNAME], [DATE] [MONTH] [YEAR] at [TIME] [ELAPSEDTIME]. A total of [TOTALVISITORS] visitors ([UNIQUEVISITORS] unique) this month, an average of [DAILYAVERAGE] per day ([DAILYUNIQUE] unique)." => "Zuletzt aktualisiert [DAYNAME], [DATE] [MONTH] [YEAR] um [TIME] [ELAPSEDTIME]. Insgesamt [TOTALVISITORS] Besuche ([UNIQUEVISITORS] individuelle Besucher) diesen Monath, durchschnittlich [DAILYAVERAGE] ([DAILYUNIQUE]) pro Tag.",
      "March" => "März",
      "May" => "Mai",
      "Monday" => "Montag",
      "No AWStats Log Files Found" => "Keine AWStats Log-Dateien gefunden",
